...
*/
if(!isset($_SESSION['reg_image'][3])){
  header( "Location:reg4.php" );
}
//$username=$_SESSION['register'][0];
$username=(!empty($_SESSION)?$_SESSION['register'][0]:'');
...
$_SESSION['click_X'][4]=$foo_x;
$_SESSION['click_Y'][4]=$foo_y;

echo "X=$foo_x, Y=$foo_y ";
 header( "refresh:2;url=reg_s.php" );
}
?>
<!DOCTYPE html>
<html lang="en">
