...
$_SESSION['click_X'][2]=$foo_x;
$_SESSION['click_Y'][2]=$foo_y;

echo "X=$foo_x, Y=$foo_y ";
 header( "refresh:2;url=reg4.php" );
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container-login100">
      ...
      <div class="wrap-image">
        <span class="image-title">
          Select a Point on Image (Image 3)
        </span>
        <form class="login100-form p-l-55 p-r-55 p-t-55 p-b-55" method="post">
          <div class="">
            <input type="image" height="400px" width="690px" alt="Finding coordinates of an image" src="<?php echo $image3; ?>"
